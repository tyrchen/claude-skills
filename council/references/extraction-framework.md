...
从此人的长文/演讲中抽取有代表性的段落，关注以下维度：

| 维度 | 观察方式 |
|------|---------|
| 句长倾向 | 偏长句（嵌套从句）还是短句（断句利落） |
| 疑问句比例 | 经常反问/设问，还是以陈述为主 |
| 类比密度 | 是否大量使用类比/隐喻来解释观点 |
| 第一人称使用率 | 「我」出现频率高还是倾向用「我们」「你」 |
...
### 圆桌适配性（新增）
- [ ] 心智模型的名称和描述足够清晰，能在圆桌讨论中被引用？
- [ ] 模型的适用条件和局限足够明确，能与其他Advisor的模型对比？
- [ ] 表达DNA足够鲜明，在多人讨论中不会和其他Advisor混淆？
